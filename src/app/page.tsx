...
export default function Page() {
  return (
    <>
      ...
      {/* <div className="grid w-full grid-cols-1 gap-x-6 gap-y-5 xl:auto-rows-[18rem] xl:grid-cols-3 xl:gap-y-10">
      ...
      <div className="grid w-full grid-cols-1 gap-x-6 gap-y-5 xl:auto-rows-[15rem] xl:grid-cols-4 xl:gap-y-10">
        <Technologies />
      </div>
    </>
  );
